        ...
        enctype="multipart/form-data">
            ...
            <div class="mb-3">
                    <label for="image" class="form-label">Post Image</label>
                        @if($post->image)
                        <div>
                            <img src="{{asset('storage/' . $post->image) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block" id="frame" style="max-height: 500px; overflow:hidden">
                        </div>  
                        @else
                        <div>
                            <img class="img-preview img-fluid mb-3 col-sm-5" id="frame" style="max-height: 500px; overflow:hidden">
                        </div>
                        @endif
