...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     * @var string
     */
    protected $secondaryKey = 'id';

    /**
     * The "type" of the secondary key ID.
     *
     * @var string
     */
    ...
    /**
     * Get the secondary key value for a select query.
     *
     * @return mixed
     */
    ...
    /**
     * Get the secondary key value for a save query.
     *
     * @return mixed
     */
    ...
    public function delete()
    {
        ...
        if (is_null($this->getKeyName())) {
            throw new LogicException('No secondary key defined on model.');
        }
    ...
    /**
     * Get the secondary key for the model.
     *
     * @return string
     */
    ...
    /**
     * Set the secondary key for the model.
     *
     * @param  string  $key
     * @return $this
     */
    ...
    /**
     * Set the data type for the secondary key.
     *
     * @param  string  $type
     * @return $this
     */
    ...
    /**
     * Get the value of the model's secondary key.
     *
     * @return mixed
     */
